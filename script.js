...
document.addEventListener('DOMContentLoaded', () => {
	...
	// Renk seçimi (şimdilik tek cihaz için: sadece "benim" rengim önemli)
	colorOptionButtons.forEach(btn => {
		btn.addEventListener('click', () => {
			const color = btn.getAttribute('data-color');
			// Aynı renk seçimini engelleme: çok oyunculu sunucu entegrasyonu yok, bu yüzden
			// tek cihazda aynı anda birden fazla kişi olmayacağı varsayımıyla
			// local olarak sadece bir kez seçilebilir yapıyoruz.
